...
// @access   Private
router.get('/attendance/:cid', async (req, res) => {
    try {
        let client = 'meeting-' + req.params.cid;
        // need to create special date for today starting at T00:00:00.000Z
        let tDate = new Date();
...
router.get('/attendanceBAK/:cid', async (req, res) => {
    try {
        let client = 'meeting-' + req.params.cid;
        // need to create special date for today starting at T00:00:00.000Z
        let tDate = new Date();
...
router.get('/test/:cid', async (req, res) => {
    try {
        let client = 'meeting-' + req.params.cid;
        // need to create special date for today starting at T00:00:00.000Z
        let tDate = new Date();
        ...
        // const attendance = await Meeting.find().sort({ meetingDate: -1,  });
        res.json(attendance);
    } catch (err) {
        console.error(err.message);
        res.status(500).send('Server Error');
