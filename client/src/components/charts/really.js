...
export const Really = ({
    ...
    // console.log('attenance: ' + attenance);
    // const dashData = JSON.parse(aData);
    // console.log('meetings: ' + dashData.meetings);
    // console.log('attendance: ' + dashData.attendance);
    // const newData = [10, 15, 20, 25, null, null, null, null, null, null];
    ...
    useEffect(() => {
        ...
        if (aData) {
            ...
            // }
            //gotta have 10
            // for (let index = meetings.size; index < 10; index++) {
            //     meetings.push(null); 
            // }
            // console.log('meetings: ' + meetings.map);
            // console.log('attendance: ' + attendance.map);
            ...
            console.log('map: ' + aData.meetings.table);
            const util = require('util');
            console.log('aData: ' +
            util.inspect(aData, { showHidden: false, depth: null }));
            // console.log('meeting[1]: ' + aData.attendance[1]);
        }
    }, [aData]);
    return (
        <div>
            <div>really client: {cid}</div>
            <div>AttenData from Dashboard<br/>
